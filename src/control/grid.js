...
$class('GridView', function () {
    ...
    this.changeCurrent = function (cell) {
        ...
        {
            any = 'flyingon-Grid-column-selected';
        ...
        {
            any = 'flyingon-Grid-row-selected';
...
$class('TreeGridView', flyingon.GridView, function (base) {
    ...
    function render_tree(writer, column, row, text) {
        ...
        if (any > 0)
        {
            writer.push('<span class="flyingon-Grid-tree-space" style="width:' + (any * 16) + 'px;"></span>');
        }

        if (children)
        {
            any = row.expanded ? 'expand' : 'collapse';
            writer.push('<span class="flyingon-Grid-tree-' + any + '" tree-' + any + '="true" no-current="true"></span>');
        }
        ...
        if (any = column.iconClass)
        {
            ...
            if (any)
            {
                writer.push('<span class="flyingon-Grid-tree-icon ' + any + '"></span>');
            }
        }
